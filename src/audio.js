export default {
    ...
    mainTheme: new Audio('../Audio/music/Main menu theme GoW 3.mp3'),
    battleTheme: new Audio('../Audio/music/Battle theme.mp3'),
    battleTheme2: new Audio('../Audio/music/GoW CoO battle theme.mp3'),
    battleTheme3: new Audio('../Audio/music/GoW CoO battle theme 2.mp3'),
    cyclopsBattle: new Audio('../Audio/music/Cyclops battle theme.mp3'),
    hadesBattle: new Audio('../Audio/music/Hades battle theme.mp3'),
    hermesBattle: new Audio('../Audio/music/Hermes battle theme.mp3'),
    herculesBattle: new Audio('../Audio/music/Hercules battle theme.mp3'),
    zeusBattle: new Audio('../Audio/music/Zeus battle theme.mp3'),

    // --- Ambience ---

    underworldAm: new Audio('../Audio/ambience/Underworld ambience.mp3'),
    olympusAm: new Audio('../Audio/ambience/Olympus ambience.mp3'),

    // --- Underworld ---

    hopliteSound: new Audio('../Audio/UI/Hoplite sound.mp3'),
    bansheeSound: new Audio('../Audio/UI/Banshee sound.mp3'),
    satyrSound: new Audio('../Audio/UI/Satyr sound.mp3'),
    gorgonSound: new Audio('../Audio/UI/Gorgon sound.mp3'),
    minotaurSound: new Audio('../Audio/UI/Minotaur sound.mp3'),
    medusaSound: new Audio('../Audio/UI/Medusa sound.mp3'),
    cyclopsSound: new Audio('../Audio/UI/Cyclops sound.mp3'),
    ...
    // Hoplite
    hopliteAttacks: [new Audio('../Audio/SFX/Hoplite attack.mp3'), new Audio('../Audio/SFX/Hoplite attack.mp3')],
