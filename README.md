...
The code has also changed due to needing global variables and functions etc. Other than that, nothing much has changed other than the fact that the UI has gotten smaller now for some reason (I'll fix that next update).
